...
@section('content')
<form action="{{ route('medicine.store') }}" method="post" class="card p-5" enctype="multipart/form-data">
    @csrf
...
<div class="mb-3 row">
    <label for="photo" class="col-sm-2 col-form-label">Gambar Obat</label>
    <div class="col-sm-10">
